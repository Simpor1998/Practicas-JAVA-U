    ...
    public static void main(String[] args) {
        ...
        Double costoEnvio = switch (destino) {
            ...
            default -> {
                ...
                // palabra YIELD arrojar o retornar un valor debido a que si o si debo retornar algo de respuesta en el SWITCH
                //Ademas el valor de null no se puede asignar a una cariable de tipo VAR tengo que especificar el tipo de dato que voy a utilizar normalmente
                yield null;
            }
        };
